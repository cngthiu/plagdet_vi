...
_STOP_SECTIONS = [
    r"^tài liệu tham khảo\b", r"^tham khảo\b",
    r"^references\b", r"^bibliography\b",
    r"^phụ lục\b", r"^phu luc\b",
]
_WS = re.compile(r"\s+")
...
def strip_tail_sections(text: str, enable: bool = True) -> tuple[str, str]:
    """Nếu enable=False → trả nguyên văn & chuỗi rỗng."""
    if not enable:
        return text, ""
